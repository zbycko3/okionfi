...
if (typeof gemius_hcconn == "undefined") {
	gemius_hcconn = {
		...
		hc : (typeof gemius_hitcollector === 'string')?gemius_hitcollector:(typeof pp_gemius_hitcollector === 'string')?pp_gemius_hitcollector:'mreg.hit.gemius.pl',
		...
		init : function() {
			...
			if (gemius_hcconn.dnt==0) {
				if (gemius_hcconn.use_cmp && gemius_cmpclient.find_cmp()) {
				...
				} else if (gemius_hcconn.gdpr_params() != '') {
